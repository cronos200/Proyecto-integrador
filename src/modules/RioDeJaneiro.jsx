...
const RioDeJaneiro = () => {
  ...
  useEffect(() => {
    fetch("/fake-api.json")
      .then((res) => res.json())
      .then((data) => {
        const rioPlan = data.planesTuristicos.find(
          (p) => p.destino === "Rio De Janeiro"
        );
        setPlan(rioPlan);
        setNoches(rioPlan.nochesBase);
      });
  }, []);
  ...
  return (
    <div className="destinos-container">
      <div className="destinos-image">
        <img src="/images/riodos.jpg" alt="Rio De Janeiro" />
      </div>

      <div className="destinos-content">
        <h2>Rio De Janeiro</h2>
        <p>
          Río de Janeiro es una deslumbrante ciudad costera en el sureste de
          Brasil, conocida por sus impresionantes playas, paisajes montañosos,
          vibrante cultura carioca y una energía contagiosa que se refleja en su
          música, festivales y estilo de vida.
        </p>
